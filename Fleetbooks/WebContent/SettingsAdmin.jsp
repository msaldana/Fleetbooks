...
<li><a href="./SettingsAdmin.jsp" class="active">Settings</a></li>
<li><a href="./index.jsp">Logout</a></li>
</ul>
</div>
</div>
<div id="Layer4" style="position:absolute;text-align:left;left:0%;top:100px;width:100%;height:728px;z-index:10;" title="">
<div id="wb_Text3" style="position:absolute;left:260px;top:30px;width:92px;height:27px;text-align:center;z-index:4;">
<span style="color:#000000;font-family:Arial;font-size:24px;">Settings</span></div>
<div id="wb_ChangePassword1" style="position:absolute;left:368px;top:79px;width:304px;height:150px;z-index:5;">

<!--  temporarly  -->



<form name="changepasswordform" method="post" action="./SettingsAdmin.jsp" id="changepasswordform">
