...
<div id="wb_Text1" style="position:absolute;left:785px;top:15px;width:172px;height:16px;z-index:0;text-align:left;">
...
<ul id="TabMenu1">
<li><a href="./HomeAdmin.jsp" class="active">Home</a></li>
...
<img src="images/img0004.gif" id="Text2" alt=""  style="position:absolute;left:265px;top:23px;width:674px;height:704px;z-index:3;">
