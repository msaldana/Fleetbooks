...
public class ViewEditEquipmentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewEditEquipmentServlet() {
        super();
	...
	/**
	 * Get the equipment the user wants to edit from the db to show it to him
	 * redirecting him to the edit Equipment page
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextUrl = "./EditEquipment.jsp";
